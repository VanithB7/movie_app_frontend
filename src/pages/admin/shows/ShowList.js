...
import {getShowRequest,deleteShowRequest} from '../../../actions/showAction';
                ...
                <table className="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      ...
                      <th className="px-4 py-3 text-center">Movie</th>
                      <th className="px-4 py-3 text-center">Theatre</th>
                  ...
                  >
                    { data && data.map((show)=>{
                      return(
                    <tr className="text-gray-700 dark:text-gray-400" key={show._id}>
