...
const DashBoard = ()=> {
    return(
         <div className="container px-6 mx-auto grid">
            ...
            <a
              className="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-[#b2385f] rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
