...
import {getMovieRequest,deleteMovieRequest} from '../../../actions/movieAction';
const MovieList = ()=> {
                ...
                <table className="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      ...
                      <th className="px-4 py-3 text-center">release date</th>
                  ...
                  >
                    { data && data.map((movie)=>{
                      return(
                    <tr className="text-gray-700 dark:text-gray-400" key={movie._id}>
                    ...
                    <img src={movie.image_url} className="h-36 w-46 " />
                      ...
                      <td className="px-4 py-3">
                       ...
                       {movie.genre_id && movie.genre_id.name}
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center space-x-4 text-sm justify-center">
                          ...
                          <button
                            className="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-[#b2385f] rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                         onClick={()=>deletehandle(movie._id)}
                          >
                            <svg
                              className="w-5 h-5"
                              aria-hidden="true"
