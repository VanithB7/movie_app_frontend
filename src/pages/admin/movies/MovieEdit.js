...
import {editMovieRequest,updateMovieRequest} from '../../../actions/movieAction';
...
let {id}= useParams();
 ...
 if(movie)
 {
    ...
    setRelase_data(movie.release_date);
    setImage_url(movie.image_url);
    setGenre_id(movie.genre_id);
 }
...
const postData={
  ...
  dispatch(updateMovieRequest(id,postData,history))
