...
import {getGenreRequest,deleteGenreRequest} from '../../../actions/genreAction';
              ...
              <div className="w-full overflow-x-auto">
                <table className="w-full whitespace-no-wrap">
                  ...
                  >
                    { data && data.map((genre)=>{
                      return(
                    <tr className="text-gray-700 dark:text-gray-400" key={genre._id}>
                      ...
                      <td className="px-4 py-3 text-sm text-center">
                      {moment(genre.createdAt).fromNow()}
                      </td>
                      <td className="px-4 py-3">
                        <div className="flex items-center space-x-4 text-sm justify-center">
                          ...
                          <button
                            className="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-[#b2385f] rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                         onClick={()=>deletehandle(genre._id)}
                          >
                            <svg
                              className="w-5 h-5"
                              aria-hidden="true"
