...
import {updateGenreRequest,editGenreRequest} from '../../../actions/genreAction';
...
const postData={
  ...
  dispatch(updateGenreRequest(id,postData,history))
            ...
            <div className="w-full overflow-hidden rounded-lg shadow-xs">
              <div className="w-full overflow-x-auto grid grid-cols-3">
                ...
                <input
                  ...
                  placeholder={editgenre} value={editgenre}
